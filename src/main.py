	...
	page.bottom_appbar = ft.BottomAppBar(
		...
		content=ft.Row(
			...
			controls=[
				...
				ft.IconButton(icon=ft.Icons.PERM_IDENTITY, icon_color=ft.Colors.WHITE),
				ft.IconButton(icon=ft.Icons.EDIT_ATTRIBUTES, icon_color=ft.Colors.WHITE),
				ft.IconButton(icon=ft.Icons.ADD_LINK, icon_color=ft.Colors.WHITE),
				#ft.Container(expand=True),
			]
		),
	)
